...
export class CometChatConfirmDialog extends LitElement {
  ...
  render() {
    return html`<div class="cc__confirm__dialog" style=${styleMap(this.dialogWrapperStyle())} >
    <div class="cc__dialog__form" >
        <div class="cc__dialog__title" style=${styleMap(this.dialogTitleStyle())}>
        ${this.title}
        </div>
        <div class="cc__dialog__message" style=${styleMap(this.dialogMessageStyle())}>
            ${this.messageText}
        </div>
        <div class="cc__dialog__buttons">
            <button type="button" class="cc__button__confirm" style=${styleMap(this.buttonConfirmStyle())} @click=${this.onConfirm}>
            ${this.confirmButtonText}
            </button>
            <button type="button" class="cc__button__cancel" style=${styleMap(this.buttonCancelStyle())} @click=${this.onCancel}>
