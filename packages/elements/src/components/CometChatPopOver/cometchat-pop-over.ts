...
export class CometChatPopOver extends LitElement {
  ...
  @property() placement: Placement = Placement.bottom;
  public deg: any = {
    top: 180,
    right: 270,
    bottom: 0,
...
`
  ...
  onclick = (e: any) => {
    ...
    this.x = e.pageX;
    this.y = e.pageY;
    (this.renderRoot as any).querySelector('.cc__tooltip').classList.toggle("hide");
    this.requestUpdate()
  }
  ...
  render() {
    return html`
<div class="cc__tooltip hide" style=${styleMap(this.toolTipWrapperStyle())}>
${this.hasToolTip ? html`<div class="cc__tooltip__pointer" style=${styleMap(this.toolTipStyles())}></div>` : nothing}
<div class="cc__tooltip__content" style=${styleMap(this.toolTipContentStyle())}>
